...
DecisionTask.prototype = {
    ...
    check_conditions: function(deciderParams) {
        ...
        // If activity has already been scheduled...
        if( deciderParams.name && this.is_activity_scheduled(deciderParams.name) ) {
            return false;
        }

        // If workflow has already been scheduled...
        if( deciderParams.name && this.childworkflow_scheduled(deciderParams.name) ) {
            return false;
        }

        // If timer has already been started...
        if( deciderParams.name && this.timer_scheduled(deciderParams.name) ) {
            return false;
        }
