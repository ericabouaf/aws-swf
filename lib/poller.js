...
Poller.prototype.start = function() {
   ...
   if (!this.intervalObject) {
    this.intervalObject = setInterval(this.poll, POLLING_INTERVAL, this);
   }
};
...
Poller.prototype.poll = function (poller = this) {
   ...
   console.log(`IS SERVER STOPED IN POOL BASE STOP:${poller.stop_poller} || PAUSE: ${poller.pause_poller}`)
