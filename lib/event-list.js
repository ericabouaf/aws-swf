...
EventList.prototype = {
  ...
  /**
   * Check the event list for an event with the specified attribute value
  ...
  _has_event_with_attribute_value: function(attributeKey, attributeValue, eventType) {
    var attributesKey = eventType.substr(0, 1).toLowerCase() + eventType.substr(1) + 'EventAttributes';
      return this._events.some(function (evt) {
         if (evt.eventType === eventType) {
            if (evt[attributesKey][attributeKey] === attributeValue) {
               return true;
            }
         }
      });
   ...
   /**
    * Check if on of the ScheduleActivityTask failed
    */
   ...
   */
   ...
   has_activity_timedout: function (activityId) {
      //return this._has_event_with_attribute_value('scheduledEventId', activityId, 'ActivityTaskTimedOut');
      return this._events.some(function (evt) {
   ...
   has_activity_failed: function (activityId) {
      //return this._has_event_with_attribute_value('scheduledEventId', activityId, 'ActivityTaskFailed');
      return this._events.some(function (evt) {
   ...
   has_activity_completed: function (activityId) {
      //return this._has_event_with_attribute_value('scheduledEventId', activityId, 'ActivityTaskCompleted');
      return this._events.some(function (evt) {
