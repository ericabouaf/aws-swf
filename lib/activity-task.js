...
ActivityTask.prototype = {
    ...
    _respond: function(opName, params, cb){
        ...
        operation.attempt(function(){
            op.call(self.swfClient,params,function (err, result) {
                  ...
                  self.onDone(err ? operation.mainError() : null, r);
                  if (cb) {
    ...
    respondCanceled: function (details, cb){
        ...
        this._respond("respondActivityTaskCanceled", params, cb)
    },
    /**
    ...
    respondCompleted: function (result, cb) {
        ...
        this._respond("respondActivityTaskCompleted", params, cb)
    },
    ...
    respondFailed: function (reason, details, cb) {
        ...
        this._respond("respondActivityTaskFailed", o, cb)
    ...
    recordHeartbeat: function (heartbeat, cb) {
        var self = this;
        var operation = utils.getRetryHelper(3)
        var params ={
          taskToken: this.config.taskToken,
